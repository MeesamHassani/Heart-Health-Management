...
def reader():
    ...
    reader = csv.reader(open(config.new_data_set,"r"),delimiter=",")
...
def train_Test_Split(training_data):
    ...
    extracted_training_data, extracted_testing_data, extracted_training_target, extracted_testing_target = train_test_split( all_attributes_data, all_target_data, test_size=0.2 )
...
def train_model(extracted_training_data, extracted_training_target):
    ...
    model =  random_forest_model.fit(extracted_training_data, extracted_training_target)
    return model
